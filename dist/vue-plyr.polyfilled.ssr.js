...
defineWellKnownSymbol$1('iterator');var SPECIES$3 = wellKnownSymbol$1('species');
...
var URLSearchParamsState = function (init) {
  ...
  if (init !== undefined) {
    if (isObject$1(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$6(init, 0) === '?' ? stringSlice$a(init, 1) : init : toString_1(init));
  }
};
